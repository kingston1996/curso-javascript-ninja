...
console.log(dalto, ze);
  ...
  */
  ...
  console.log(getFullName.call(dalto));
  ...
  */
  function sum(){
   ...
   return Array.prototype.reduce.call(arguments, function(acumulado, atual){
      return +acumulado + +atual; //converte para Number o +(variavel)
    });
  }
  ...
  */
  ...
  console.log('Nº\'s inseridos pelos usuários: ', numbers);
