...
*/
	var sul = ['Paraná','Santa Catarina','Rio Grande do Sul','São Paulo', 'Mato Grosso do Sul'];
...
*/
	var quant = brasil.every(function(item){
		return item.length > 7;
	});
	
console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?', quant ? 'Sim, todos os estados tem mais de 7 letras!' 
																									: 'Nem todos os estados tem mais de 7 letras!' );
// ?
